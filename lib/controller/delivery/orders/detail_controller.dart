...
import 'package:efor/data/data_sourse/remote/delivery/orders/details_data.dart';
import 'package:efor/data/model/cart_model.dart';
import 'package:efor/data/model/orders_model.dart';
import 'package:get/get.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';

class DeliveryOrdersDetailsController extends GetxController {
  ...
  DeliveryOrdersDetailsData ordersDetailsData =
      DeliveryOrdersDetailsData(Get.find());
